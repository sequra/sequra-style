...
Ruby is the main language at SeQura. We are primarily a Ruby company and Ruby 
is the go-to language for new projects and scripting.

We expect all developers at SeQura to have at least a passing understanding of
Ruby. What follows is a loose coding style to follow while developing in Ruby.

This Style Guide is based on [Shopify's Ruby Style
 Guide](https://github.com/Shopify/ruby-style-guide), adapted to SeQura.
...
Our pipelines enforce this Style Guide using RuboCop. While we don't expect you
to comply with every single rule, we do expect you to have a good reason for
breaking a style rule and adding exceptions to the RuboCop configuration.
...
* [Avoid monkeypatching](https://shopify.engineering/the-case-against-monkey-patching).
